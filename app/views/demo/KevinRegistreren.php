...
<form style="width: 300px; position: relative; margin: 3px auto; text-align: center; display: block;" method="post" action="actionpage.php">
    ...
    <div class="form-group">
        <input type="password" name="psw" class="form-control" placeholder="Wachtwoord" required>
    </div>
    <div class="form-group">
        <input type="password" name="psw1" class="form-control" placeholder="Wachtwoord check" required>
    </div>
    <div class="form-group">
...
//versleutelt het wachtwoord
        ...
        $hashed_password = $hashed_password . "pinguin5";
